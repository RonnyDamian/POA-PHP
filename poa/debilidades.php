    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-md-12" >
          ...
          <div class="card card-info" id="tabla1">
            ...
            <form  id="formOp"  method="post" onsubmit="return  data();">
              <div class="card-body row mt-3">
                ...
                <div class="col-md-4">
                  <button type="submit" class="btn btn-info float-left" style="margin-top:32px" >
          ...
          <div class="row">
            <div class="col-12">
              <form class="card card-info" id="tabla">
                <!-- /.card-header -->
                <!-- /.card-body -->
              </form>
              <!-- /.card -->
...
<script src="js/dataDebilidades.js"></script>
<?php
