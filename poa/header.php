...
<div class="wrapper bg-dark">
    ...
    <ul class="navbar-nav ml-auto  ">
      <li class="nav-item">
        <a class="nav-link"  data-widget="control-sidebar" data-slide="true" href="#" role="button">
          <i class="fas fa-external-link-square-alt text-white" ></i>
           </a>
      </li>
    </ul>
  </nav>
  ...
  <aside class="main-sidebar  elevation-4"  >
    ...
    <a href="home.php" class="brand-link" style="background-color: #28a745;" >
      <img src="../dist/img/icono.png" alt="Plan Operativo Anual" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text text-white"> Plan Operativo Anual </span>
    </a>
