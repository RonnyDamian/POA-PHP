...
function data(){
  ...
  tabla+="<div class='modal-footer'><button type='submit' class='btn btn-md btn-danger'><b>Guardar</b></button><a href='fortalezas.php' class='btn btn-md btn-danger'><b>Continuar</b></a></div>"
